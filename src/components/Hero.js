...
const BrainSVG = () => (
    <svg className="hero-brain-svg" viewBox="0 0 500 500" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path
            d="M250 120 C220 115 185 125 165 145 C140 168 132 198 135 220 C138 242 148 258 145 278 C142 298 130 310 132 328 C135 348 155 368 175 375 C195 382 220 378 235 372 L250 370"
            stroke="url(#brainGrad1)" strokeWidth="2.5" strokeLinecap="round" fill="none" filter="url(#brainGlow)"
        />
        {/* Brain outline - right hemisphere */}
        <path
            d="M250 120 C280 115 315 125 335 145 C360 168 368 198 365 220 C362 242 352 258 355 278 C358 298 370 310 368 328 C365 348 345 368 325 375 C305 382 280 378 265 372 L250 370"
            stroke="url(#brainGrad2)" strokeWidth="2.5" strokeLinecap="round" fill="none" filter="url(#brainGlow)"
        />
        {/* Center divider */}
        ...
        {[
            [200, 165], [172, 238], [162, 312], [185, 358],
            [300, 165], [328, 238], [338, 312], [315, 358],
            [250, 150], [250, 245], [250, 340],
        ].map(([cx, cy], i) => (
            <g key={i}>
        ...
        {[
            "M200 165 L250 150", "M300 165 L250 150",
            "M200 165 L172 238", "M300 165 L328 238",
            "M172 238 L250 245", "M328 238 L250 245",
            "M172 238 L162 312", "M328 238 L338 312",
            "M162 312 L250 340", "M338 312 L250 340",
            "M162 312 L185 358", "M338 312 L315 358",
            "M250 245 L250 340",
        ].map((d, i) => (
            ...
            <div className="container hero-container">
                ...
                >
                    ...
                    <motion.p className="hero-desc" variants={itemVariants}>
                        Pioneering the intersection of <strong>Deep Learning</strong> and{' '}
                        <strong>Medical Imaging</strong> to build AI systems that enhance diagnostic
                        accuracy, accelerate disease detection, and ultimately save lives.
                    </motion.p>
                    ...
                    <motion.div className="hero-socials" variants={itemVariants}>
                        {[
                            ...
                            { href: 'https://linkedin.com/', icon: 'LI', label: 'LinkedIn' },
                            { href: 'https://scholar.google.com/', icon: 'GS', label: 'Scholar' },
                            { href: 'https://researchgate.net/', icon: 'RG', label: 'ResearchGate' },
                        ].map((s) => (
                ...
                {/* Right: Animated Brain Visualization */}
                <motion.div
                ...
                >
                    <div className="brain-wrapper">
                        ...
                        {[
                            ...
                            { label: 'GAN', icon: '⚡', pos: 'bottom-right' },
                        ].map((badge) => (
                            <motion.div
                                key={badge.label}
                                className={`float-badge badge-${badge.pos}`}
                                animate={{ y: [0, -10, 0] }}
